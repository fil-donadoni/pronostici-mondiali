...
- **Tabellone (Fase 2)**, per partita: punteggio esatto (gol casa+ospite del 120', prima dei rigori) = 3; altrimenti **chi-passa** azzeccato (la squadra data per avanzante è quella davvero avanzata, incl. supplementari/rigori) = 1; **non** cumulabili (max 3). Un esatto resta 3 anche col rigorista indicato sbagliato (i rigori non spostano l'esatto). Il chi-passa premia chi indovina il passaggio del turno pur sbagliando il punteggio del 120' — es. reale 1-1, previsione 2-4 con la propria squadra che passa: 1 punto. _(Storia: in origine esatto 3 + chi-passa 1 cumulabili max 4; 2026-06 allineato ai Gironi su 1/X/2; poi ri-cambiato a esatto 3 / chi-passa 1 non cumulabili su richiesta — l'esito 1/X/2 nel knockout è insensato, conta chi passa.)_
