/**
 * Tabella UFFICIALE FIFA delle 8 migliori terze (Annex C, regolamento
 * FIFA World Cup 2026) — 495 combinazioni, una per ogni scelta di 8 gironi
 * su 12 (C(12,8)=495). Fonte: regolamento FIFA / Wikipedia knockout stage.
 *
 * Chiave: le 8 lettere dei gironi le cui terze si qualificano, ordinate.
 * Valore: { gironeVincente -> gironeDellaTerza } per gli 8 match R32 che
 * oppongono una 1ª a una terza (vincenti di A,B,D,E,G,I,K,L).
 *
 * GENERATO AUTOMATICAMENTE — non modificare a mano.
 */
import type { GroupCode } from "./structure";

// Valore: solo gli 8 gironi vincenti che affrontano una terza (A,B,D,E,G,I,K,L).
export const THIRD_PLACE_TABLE: Record<
  string,
  Partial<Record<GroupCode, GroupCode>>
> = {
